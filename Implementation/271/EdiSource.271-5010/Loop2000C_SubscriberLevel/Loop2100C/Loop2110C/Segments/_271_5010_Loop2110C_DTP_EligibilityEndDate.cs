...
[SegmentGenerator<Loop2100C.Loop2110C._271_5010_Loop2110C_SubscriberEligibilityOrBenefitInfo>("DTP", "347")]
public sealed partial class _271_5010_Loop2110C_DTP_EligibilityEndDate
{
    ...
    public DateOnly? EligibilityEndDate { get => SegmentExtensions.GetDateOnly(this, 3); set => this.SetDateOnly(value, 3); }
}
