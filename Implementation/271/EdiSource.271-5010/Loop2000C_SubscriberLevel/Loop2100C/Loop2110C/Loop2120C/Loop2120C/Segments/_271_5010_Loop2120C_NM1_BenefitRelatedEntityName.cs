...
[SegmentGenerator<_271_5010_Loop2120C_BenefitRelatedEntity>("NM1")]
public sealed partial class _271_5010_Loop2120C_NM1_BenefitRelatedEntityName
{
    ...
    public string? BenefitRelatedEntityLastOrOrganizationName
    {
        get => GetCompositeElement(3);
        set => SetCompositeElement(value, 3);
    }

    public string? BenefitRelatedEntityFirstName
    {
        get => GetCompositeElement(4);
        set => SetCompositeElement(value, 4);
    }

    public string? BenefitRelatedEntityMiddleName
    {
