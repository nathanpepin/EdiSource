...
public partial class _271_5010_Loop2100C_NM1_SubscriberName
{
    ...
    public string? SubscriberLastName { get => GetCompositeElement(3); set => SetCompositeElement(value, 3); }
    public string? SubscriberFirstName { get => GetCompositeElement(4); set => SetCompositeElement(value, 4); }
    public string? SubscriberMiddleName { get => GetCompositeElement(5); set => SetCompositeElement(value, 5); }
    ...
    public string? SubscriberIdentifier { get => GetCompositeElement(9); set => SetCompositeElement(value, 9); }
}
