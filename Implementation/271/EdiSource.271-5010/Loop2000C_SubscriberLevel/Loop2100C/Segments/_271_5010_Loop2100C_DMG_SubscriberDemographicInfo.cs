...
public partial class _271_5010_Loop2100C_DMG_SubscriberDemographicInfo
{
    ...
    public string? RaceOrEthnicityCode1
    {
        get => GetCompositeElement(5, 1);
        set => SetCompositeElement(value, 5, 1);
    }

    public string? RaceOrEthnicityCode2
    {
        get => GetCompositeElement(5, 2);
        set => SetCompositeElement(value, 5, 2);
    }

    public string? RaceOrEthnicityCode3
    {
        get => GetCompositeElement(5, 3);
        set => SetCompositeElement(value, 5, 3);
    }
