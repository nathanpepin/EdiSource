...
public partial class _271_5010_Loop2000D_TRN_DependentTraceNumber
{
    public string? TraceTypeCode { get => GetCompositeElement(1); set => SetCompositeElement(value, 1); }
    public string? DependentTraceNumber { get => GetCompositeElement(2); set => SetCompositeElement(value, 2); }
