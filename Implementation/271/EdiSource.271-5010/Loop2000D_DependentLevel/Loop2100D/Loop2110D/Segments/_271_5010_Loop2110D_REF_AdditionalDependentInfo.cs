...
[SegmentGenerator<_271_5010_Loop2110D_DependentEligibilityOrBenefitInfo>("REF")]
public sealed partial class _271_5010_Loop2110D_REF_AdditionalDependentInfo
{
    public string? ReferenceIdentificationQualifier { get => GetCompositeElement(1); set => SetCompositeElement(value, 1); }
    public string? AdditionalDependentIdentifier { get => GetCompositeElement(2); set => SetCompositeElement(value, 2); }
