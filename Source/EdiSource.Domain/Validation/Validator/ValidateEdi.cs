...
public sealed class ValidateEdi : IValidateEdi
{
        ...
        ref int loopLine, ref int segmentLine) where T : IEdi
    {
        ...
        switch (ediItem)
        {
            ...
            case IEnumerable<ILoop> loopList:
                HandleLoopList<T>(validationResult, out loopLine, ref segmentLine, loopList);
                break;
        }
    ...
    private static void HandleLoopList<T>(EdiValidationResult validationResult, out int loopLine, ref int segmentLine,
