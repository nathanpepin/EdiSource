...
/// <summary>
///     Validates that a composite element value is a valid date/time.
...
/// <param name="format">Optional date/time format string. When null, standard EDI date formats are tried.</param>
