...
namespace Test
{
    public partial class TransactionSet
    {
        ...
        public static Task<TransactionSet> InitializeAsync(ChannelReader<Segment> segmentReader, ILoop? parent)
        {
            if (parent is null)
            {
        ...
        public static async Task<TransactionSet> InitializeAsync(ChannelReader<Segment> segmentReader, TransactionSet? parent)
        {
