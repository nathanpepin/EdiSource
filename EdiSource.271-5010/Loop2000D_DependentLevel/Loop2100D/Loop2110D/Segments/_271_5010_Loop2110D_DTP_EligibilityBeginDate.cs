...
public partial class _271_5010_Loop2110D_DTP_EligibilityBeginDate
{
    ...
    public DateOnly? EligibilityBeginDate { get => this.GetDateOnly(3); set => this.SetDateOnly(value, 3); }
}
