...
[SegmentGenerator<_271_5010_Loop2110C_SubscriberEligibilityOrBenefitInfo>("DTP", "347")]
public partial class _271_5010_Loop2110C_DTP_EligibilityEndDate
{
    ...
    public DateOnly? EligibilityEndDate { get => this.GetDateOnly(3); set => this.SetDateOnly(value, 3); }
}
